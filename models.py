...
class Experience(db.Model):
    ...
    type = db.Column(db.String(50))  # project, experience, award
...
class JobInformation(db.Model):
    ...
    required_documents = db.Column(db.String(255)) 
    internship_pay = db.Column(db.String(50))
...
class ApplicationStatus(db.Model):
    ...
    feedbac = db.Column(db.Text, nullable=True)
